...
{
    [CreateAssetMenu(fileName = nameof(StrongholdInspectorViewModelFactory), menuName = MenuName.Factory + ProjectMenuName.InGameEditor + nameof(StrongholdInspectorViewModel))]
    public class StrongholdInspectorViewModelFactory : ScriptableObject, IFactory<StrongholdInspectorViewModel>
    {
        ...
        public StrongholdInspectorViewModel Create() => new StrongholdInspectorViewModel(currentInspectableRepositoryProvider.Provide(), mapRepositoryProvider.Provide());
    }
}
...
namespace Noneb.Core.InGameEditor.Data
{
    ...
    {
        [FormerlySerializedAs("availableTileDatas")] [SerializeField]
        private AvailableTilePresets availableTilePresets;

        [FormerlySerializedAs("availableConstructDatas")] [SerializeField]
        private AvailableConstructPresets availableConstructPresets;

        [FormerlySerializedAs("availableUnitDatas")] [SerializeField]
        private AvailableUnitPresets availableUnitPresets;

...
{
    public class SetUpStrongholdInMapCommand : ICommand
    {
        ...
        public IObservable<Unit> Do() => GameActions.Stronghold.SetUpStrongholdInMap(_coordinate, _mapEditingService, _mapGetService);

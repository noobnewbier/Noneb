namespace Noneb.Core.Game.Common.Constants
{
    public static class ObjectTags
    {
        ...
        #region BoardItem's GameObjects

        public const string UnitGameObject = "UnitGameObject";
        public const string ConstructGameObject = "ConstructGameObject";
